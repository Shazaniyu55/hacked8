	...
	document.querySelector(".tp").classList.add("active")
...
document.querySelector(".open").addEventListener("click", function(){
	...
	document.querySelector(".tp").classList.remove("active")
...
document.querySelector(".open2").addEventListener("click", function(){
    ...
    document.querySelector(".closee").classList.add("active")
    document.querySelector(".open2").classList.add("active")

	document.querySelector(".closee2").classList.add("active")
    document.querySelector(".open").classList.add("active")
...
document.querySelector(".closee2").addEventListener("click", function(){
    // window.alert("llll")
	  document.querySelector(".side-bar").classList.remove("active")
	document.querySelector(".li1").classList.remove("active")
	document.querySelector(".li2").classList.remove("active")
	...
	document.querySelector(".closee").classList.remove("active")
    document.querySelector(".open2").classList.remove("active")

	document.querySelector(".closee2").classList.remove("active")
    document.querySelector(".open").classList.remove("active")
